          ...
          this.jKanban = function () {
            ...
            this.addBoards = function (boards, isInit) {
              ...
              for (var boardkey in boards) {
                ...
                if (board.isDisabled) {
                  contentBoard.classList.add("drop-disabled");
                }
                ...
                //Raj added -->
                if (board.style !== "" && board.style !== undefined)
                  headerBoard.setAttribute("style", board.style);
                // <-- Raj added
                ...
                for (var itemkey in board.item) {
                  ...
                  //Raj added -->
                  if (itemKanban.style !== "" && itemKanban.style !== undefined)
                    nodeItem.setAttribute("style", itemKanban.style);
                  // <-- Raj added
          ...
          function dragula(initialContainers, options) {
            ...
            function findDropTarget(elementBehindCursor, clientX, clientY) {
              ...
              if (target) {
                ...
                if (targetClass.indexOf("drop-disabled") > -1) {
                  return null;
                } else {
                  return target;
                }
